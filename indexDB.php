...
<header>Welcome to RunWithMe App</header>
	...
	<pre><?php
					...
					echo "<br>";
					echo "above is the user's profile as inserted to DB: ";echo "<br>";echo "<br>";
					...
					echo "(`id`, `idUser_facebook`, `name`, `link`, `username`, `hometown`, `location`, `education1`, `education2`, `education3`, `education4`, `gender`, `religion`, `political`, `timezone`, `locale`, `languages1`, `languages2`, `verified`, `updated_time`, `Uid`)";
