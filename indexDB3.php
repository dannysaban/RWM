...
-->
	...
	if ($user) {
		try {
			...
			if (!$get_loc){
				echo "Facebook_Location: " . $get_loc = 0; echo "<br>";
			}
			...
			if (!$get_edu){
				echo "Facebook_Education: " . $get_edu = 0; echo "<br>";
			}
			...
			if (!$get_edu){
				echo "Facebook_Work: " . $get_edu = 0; echo "<br>";
			}
			...
			$user = null;
					...
					$count = 0;
					//global $myUp;
					foreach ( $user_profile as $up => $val ) { //main loop over arrays of values
						...
						if( $up == 'political' || $up == 'gender' || $up == 'religion' || $up == 'timezone' || $up == 'locale' || $up == 'verified' || $up == 'updated_time' || $up == 'username' || $up == 'id' || $up == 'name' || $up == 'first_name' || $up == 'last_name' || $up == 'link' ){
							echo ++$count.") ";
					...
					echo "<br>";
					echo "There are ".$count. " items for insertion to DB."; echo "<br>";
					echo "(** there should be 19 items)"; echo "<br>";
					echo "<br>";	echo "<br>";    echo "<hr>";
					
					$format = 'id'. "<br>";
					$format .= 'name'. "<br>";
					$format .= 'first_name'. "<br>";
					$format .= 'last_name'. "<br>";
					$format .= 'link '. "<br>";
					$format .= 'username'. "<br>";
					$format .= 'hometown '. "<br>";
					$format .= 'location '."<br>";
					$format .= 'work '. "<br>";
					$format .= 'education (only 1 name)'. "<br>";
					$format .= 'education (only 1 type)'. "<br>";
					$format .= 'gender '. "<br>";
					$format .= 'religion '. "<br>";
					$format .= 'political '. "<br>";
					$format .= 'timezone '."<br>";
					$format .= 'locale '. "<br>";
					$format .= 'languages (only 1)'. "<br>";
					$format .= 'verified '. "<br>";
					$format .= 'updated_time '. "<br>";
					
					echo "Please provide us with the belowed items so we can much you with the best running partner!";echo "<br>";
						
					echo "Here is the data types you should provide:"; echo "<br>";echo "<br>";
					
					echo $format;echo "<hr>";
					
					if ($count !== 19){
						echo "<br>";
						echo "there is a problem with the rows count for DB insertion - there should be 19 rows for insertion";
						echo "<br>";
					}
						...
						echo "below is the user's profile as inserted to DB: ";echo "<br>";echo "<br>";
					...
					//'100003538821460', 'Danny Milo-saban', 'Danny', 'Milo-saban', 'http://www.facebook.com/danny.milosaban', 'danny.milosaban', 'Haifa, Israel', 'Tel Aviv, Israel', 'Bosmat, Haifa', 'High School', 'Hebrew University of Jerusalem', 'College', 'male', 'Atheist', 'Radical Left', '3', 'en_US', 'Hebrew', 'English', '1', '2012-08-19T18:38:09+0000',
						...
						try {
							...
							$sql2 = "INSERT INTO `harmoney_run_with_me`.`User_facebook` (`id`, `idUser_facebook`, `name`, `first_name`, `last_name`, `link`, `username`, `hometown`, `location`, `work`, `education3`, `education4`, `gender`, `religion`, `political`, `timezone`, `locale`, `languages1`, `verified`, `updated_time`, `Uid`) VALUES ('NULL', $database '$getID');";
